...
zooHeading.addEventListener('click', ()=>{
    if (zooHeading.style.top == "10%" && zooHeading.style.left == "12%" && zooHeading.style.fontSize == "2rem" && zooDetail.style.opacity == "1" && zooBuyBtn.style.opacity == "1" && zooBuyBtn.style.pointerEvents == "all") {
        zooHeading.style.top = "50%";
        zooHeading.style.left = "50%";
        zooHeading.style.fontSize = "6rem";
        zooDetail.style.opacity = "0";
        zooBuyBtn.style.opacity = "0";
        zooBuyBtn.style.pointerEvents = "none";
    } else {
        zooHeading.style.top = "10%";
        zooHeading.style.left = "12%";
...
museumHeading.addEventListener('click', ()=>{
    if (museumHeading.style.top == "10%" && museumHeading.style.left == "12%" && museumHeading.style.fontSize == "2rem" && museumDetail.style.opacity == "1" && museumBuyBtn.style.opacity == "1" && museumBuyBtn.style.pointerEvents == "all") {
        museumHeading.style.top = "50%";
        museumHeading.style.left = "50%";
        museumHeading.style.fontSize = "6rem";
        museumDetail.style.opacity = "0";
        museumBuyBtn.style.opacity = "0";
        museumBuyBtn.style.pointerEvents = "none";
    } else {
        museumHeading.style.top = "10%";
        museumHeading.style.left = "12%";
